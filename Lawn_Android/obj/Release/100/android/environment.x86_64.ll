...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"91f1b8c8-7647-4dd7-a648-df2eab3db30d\00", align 16
...
@__DSOCacheEntry_name.7 = internal constant [15 x i8] c"libopenal32.so\00", align 1
...
@dso_cache = local_unnamed_addr global [28 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__DSOCacheEntry_name.7, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 14
	%struct.DSOCacheEntry {
