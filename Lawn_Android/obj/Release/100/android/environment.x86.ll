...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"91f1b8c8-7647-4dd7-a648-df2eab3db30d\00", align 1
...
@__DSOCacheEntry_name.3 = internal constant [15 x i8] c"libopenal32.so\00", align 1
...
@__DSOCacheEntry_name.6 = internal constant [12 x i8] c"libBugly.so\00", align 1
...
@dso_cache = local_unnamed_addr global [28 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__DSOCacheEntry_name.6, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 9
	%struct.DSOCacheEntry {
